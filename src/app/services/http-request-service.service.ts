...
export class HttpRequestServiceService {
  ...
  getAllCollectionAgents() {
    const options = {
      params: new HttpParams().set("mobileNo", this.userDetails.mobileNo)
      // .set('mobileNo', "9941840515")
    };
    return this.httpClient.get(
      this.pageUrl + "/getCollectionAgents.php",
      options
    );
  }
  ...
  updateAgentInfo(agentInfo: EditAgentApiInfo) {
    agentInfo.mobileNo = this.userDetails.mobileNo;
    return this.httpClient.get(
      this.pageUrl + "/updateCollectionAgentNameAndPassword.php",
      {
        params: Object.entries(agentInfo).reduce(
          (params, [key, value]) => params.set(key, value),
          new HttpParams()
  ...
  updateVillageInfo(villageInfo) {
    ...
    return this.httpClient.get(
      this.pageUrl + "/updateVillageName.php",
      options
    );
  }
  ...
  addFarmer(farmerDialogData: AddFarmerDialogData) {
    ...
    const options = {
      params: new HttpParams()
        ...
        .set("farmerNo", farmerDialogData.farmerFormData.farmerNo)
    };
  ...
  getFarmersByVillageName(villageInfo) {
    ...
    return this.httpClient.get(
      this.pageUrl + "/getAllFarmersOfVillage.php",
      options
    );
  }
  ...
  deleteFarmerInfo(farmerInfo: FarmerTableRowData) {
    ...
    const options = {
      params: new HttpParams()
        .set("mobileNo", this.userDetails.mobileNo)
        .set("farmerNo", farmerInfo.farmer_no)
    };
